...
int main()
{
    ...
    Shader cubeShader("shaders/colorShader.vs", "shaders/colorShader.fs");

    // load models
    // -----------
    Model poolBall("res/objects/poolballs/12ball.obj");
    vec3 lightColor = vec3(1.0f);
    vec3 lightPos = vec3(0.0f, 4.0f, -4.0f);
    Mesh lightingCube(glm::vec4(lightColor, 1.0f));
